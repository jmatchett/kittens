...
class KittensControllerTest < ActionController::TestCase
  ...
  test "should create kitten" do
    assert_difference('Kitten.count') do
      post :create, kitten: { comments_id: @kitten.comments_id, link: @kitten.link, user_id: @kitten.user_id }
    end
  ...
  test "should update kitten" do
    patch :update, id: @kitten, kitten: { comments_id: @kitten.comments_id, link: @kitten.link, user_id: @kitten.user_id }
    assert_redirected_to kitten_path(assigns(:kitten))
  end
